...
class Launcher extends Component {
  ...
  onMouseEnter(ev) {
    ...
    [...document.querySelectorAll('.coverart')].forEach((el) => {
  ...
  onDrop([file]) {
    ...
    reader.onload = () => {
      ...
      const isValid = (view.byteLength > 64) &&
        view.getUint16(0x4) <= view.byteLength &&
        view.getUint16(0x6) <= view.byteLength &&
        view.getUint16(0x8) <= view.byteLength &&
        view.getUint16(0xA) <= view.byteLength &&
        view.getUint16(0xC) <= view.byteLength &&
      ...
      if (isValid && isRightVersion) {
        ...
        fileDB.save(name, buf).then(() => {
          this.setState({ files: [...this.state.files, name] });
        });
      } else {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className="bg-header tilt">
          <div className="max-container untilt">

            <div className="nav-bar">
              <div className="name">Encrusted</div>
            </div>
        ...
        <div className="max-container">
          <div className="contents">
            ...
            <div className="launcher super-center">
              <div className="files">
            ...
            <div className="features">
              <div className="item">
                <div>
                  <span className="feat-icon">
                    <span><i className="icon ion-location"></i></span>
                  </span>
                  <div>
                    <h4>
                      Live mapping
                    ...
                    <p>
                      Bad at directions? Generate a map as you travel.
                    </p>
                  </div>
                </div>
                <img src="./img/feat-map.jpg" alt="map generation" />
              </div>

              <div className="item">
                <div>
                  <span className="feat-icon">
                    <span><i className="icon ion-merge pl-1"></i></span>
                  </span>
                  <div>
                    <h4>
                ...
                <img src="./img/feat-tree.jpg" alt="object tree" />
              </div>

              <div className="item">
                <div>
                  <span className="feat-icon">
                    <span><i className="icon ion-ios-skipbackward"></i></span>
                  </span>
                  <div>
                    <h4>
                      Time Travel
                    ...
                    <p>
                      Step through moves with undo/redo support, including <span className="hotkey">ctrl + z</span>'s.
                    </p>
                  </div>
                </div>
                <img src="./img/feat-undo.jpg" alt="undo support" />
              </div>
              ...
              <div className="item">
                <div>
                  <span>
                    <span className="feat-icon">
                      <span><i className="icon ion-android-volume-up"></i></span>
                    </span>
                    <span className="feat-icon under">
                      <span><i className="icon ion-android-microphone"></i></span>
                    </span>
                  </span>

                  <div>
                    <h4>
                      Narration &amp; Voice Commands
                    </h4>
                    <p>
                      <span className="sm">(voice control only available in chrome)</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="footer">
          <div className="max-container">
            <div className="contents">
              ...
              <span className="super-center">
                Encrusted is <a href="https://github.com/demille/encrusted" className="ml-1 mr-2">open source.</a>
                <a className="github-button" href="https://github.com/demille/encrusted/fork" data-icon="octicon-repo-forked" aria-label="Fork demille/dnssd.js on GitHub">Fork Me</a>
              </span>
            </div>
          </div>
        </div>
...
export default connect(
  null,
  dispatch => ({
    startWorker: () => dispatch({ type: 'PRELOAD' }),
